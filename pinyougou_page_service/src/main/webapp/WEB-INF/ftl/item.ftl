...
<#--尚品扩展信息-->
<#assign customAttributeItemList=tbGoodsDesc.customAttributeItems?eval>
		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					...
					<li class="active">${tbgoods.goodsName}系类</li>
				</ul>
			</div>
			<!--product-info-->
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img jqimg="${itemImageList[0].url}" src="${itemImageList[0].url}" width="400px" height="500px" /></span>
						</div>
						<!--下方的缩略图-->
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<#list customAttributeItemList as customAttributeItem>
