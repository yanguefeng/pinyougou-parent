 //控制层 
app.controller('contentController' ,function($scope,$controller,uploadFileService2 ,contentService,contentCategoryService){
    ...
    $scope.upload=function () {
        ...
        uploadFileService2.upload().success(function (respones) {
            if (respones.success){
                $scope.entity.pic=respones.message;//设置文件地址
            }else{
